...
namespace PanelGen.Cli
{
    public class HersheyFont
    {
        ...
        public void DrawString(IDraw drw, string text, float x, float y)
        {
            var offx = x;
            var offy = y;
            ...
            foreach (var c in text)
            {
                ...
                offx += (glyph.posR - glyph.posL)*_scale;
            }
        }
        ...
        private readonly int[] _asciiMapRomanSimplex = {
            ...
            616, 617, 617, 619, 620, 621, 622, 623, 624, 625, 626, 2225, 723, 2226, 2246, 718 // 70-7Fh
        };
